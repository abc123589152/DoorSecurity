...
#Setting reedswitch pin port to gpio
# def set_reedswitch_to_gpio(uartport,controlip):
...
#     count_uart4 = 0
#     if uartport=='uart1':
#         doorname = dbConnect("select door from doorsetting where wiegand = %s",(uartport,),controlip)
...
def checkdoorsensor(uartport):
    ...
    while True:
        ...
        # if uartport == 'uart1':
        #     print(f"uart1:{reedswitch_uart1.getnewpin()}")
        # if uartport == 'uart4':
        #     print(f"uart4:{reedswitch_uart4.getnewpin()}")
        # print(reedswitch_uart4.getnewpin())
        # #if count = 0 set gpiozero button,count != 0 do nothing
        # if uartport == 'uart1' and count_uart1 == 0 and reedswitch_uart1.getnewpin()!=0:
        #     count_uart1+=1
        #     set_input_switch_uart1 = gpiozero.Button(reedswitch_uart1.getnewpin())
        # if uartport == 'uart4' and count_uart4 == 0 and reedswitch_uart4.getnewpin()!=0:
        #     count_uart4+=1
        #     set_input_switch_uart4 = gpiozero.Button(reedswitch_uart4.getnewpin())
        
        #check is uart1 and reedswitchdict uart1 value not equal not to get reedswitch pin
        ...
        if uartport == 'uart1' and reedswitchdict.get('uart1')!=reedswitch_uart1.getnewpin():
            ...
            if reedswitchdict['uart4']!=0:
                    ...
                    if "is_active=True" in str(set_input_switch_uart4):
                        ...
                        set_input_switch_uart3.close()
        # if uartport == 'uart1':
        #      print(f"uart1:{set_input_switch_uart1}")
        #      print(reedswitchdict)
        #      time.sleep(2)
        # if uartport == 'uart2':
        #      print(f"uart2:{set_input_switch_uart2}")
        #      print(reedswitchdict)
        #      time.sleep(2)
        ...
        # if uartport == 'uart1' and set_input_switch_uart1!=0 and "is_active=True" in str(set_input_switch_uart1):
        #     return set_input_switch_uart1
        # else:
        #     return 0 
        # if uartport == 'uart2' and set_input_switch_uart2!=0 and "is_active=True" in str(set_input_switch_uart2):
        #     checkdoorstatus(set_input_switch_uart2,uartport,controlip)
        # if uartport == 'uart3' and set_input_switch_uart3!=0 and "is_active=True" in str(set_input_switch_uart3):
        #     checkdoorstatus(set_input_switch_uart3,uartport,controlip)
